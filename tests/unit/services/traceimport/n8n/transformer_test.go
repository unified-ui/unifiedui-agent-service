...
func TestN8NTransformer_MapNodeType(t *testing.T) {
	...
	testCases := []struct {
		...
		{"n8n-nodes-base.postgres", models.NodeTypeDatabase},
		{"n8n-nodes-base.mongoDb", models.NodeTypeDatabase},
		...
		{"n8n-nodes-base.html", models.NodeTypeDataTransform},
		// New: Database nodes
		{"n8n-nodes-base.microsoftSql", models.NodeTypeDatabase},
		{"n8n-nodes-base.elasticsearch", models.NodeTypeDatabase},
		{"n8n-nodes-base.supabase", models.NodeTypeDatabase},
		{"n8n-nodes-base.snowflake", models.NodeTypeDatabase},
		{"n8n-nodes-base.azureCosmosDb", models.NodeTypeDatabase},
		{"n8n-nodes-base.redis", models.NodeTypeDatabase},
		// New: Queue nodes
		{"n8n-nodes-base.kafka", models.NodeTypeQueue},
		{"n8n-nodes-base.rabbitMq", models.NodeTypeQueue},
		{"n8n-nodes-base.amqp", models.NodeTypeQueue},
		{"n8n-nodes-base.mqtt", models.NodeTypeQueue},
		// New: Data Transform nodes
		{"n8n-nodes-base.dateTime", models.NodeTypeDataTransform},
		{"n8n-nodes-base.crypto", models.NodeTypeDataTransform},
		{"n8n-nodes-base.xml", models.NodeTypeDataTransform},
		{"n8n-nodes-base.sort", models.NodeTypeDataTransform},
		{"n8n-nodes-base.splitOut", models.NodeTypeDataTransform},
		{"n8n-nodes-base.summarize", models.NodeTypeDataTransform},
		{"n8n-nodes-base.compareDatasets", models.NodeTypeDataTransform},
		{"n8n-nodes-base.removeDuplicates", models.NodeTypeDataTransform},
		{"n8n-nodes-base.itemLists", models.NodeTypeDataTransform},
		{"n8n-nodes-base.rssFeedRead", models.NodeTypeDataTransform},
		// New: App nodes
		{"n8n-nodes-base.slack", models.NodeTypeApp},
		{"n8n-nodes-base.discord", models.NodeTypeApp},
		{"n8n-nodes-base.telegram", models.NodeTypeApp},
		{"n8n-nodes-base.microsoftTeams", models.NodeTypeApp},
		{"n8n-nodes-base.gmail", models.NodeTypeApp},
		{"n8n-nodes-base.googleSheets", models.NodeTypeApp},
		{"n8n-nodes-base.jira", models.NodeTypeApp},
		{"n8n-nodes-base.hubSpot", models.NodeTypeApp},
		{"n8n-nodes-base.googleDrive", models.NodeTypeApp},
		{"n8n-nodes-base.github", models.NodeTypeApp},
		{"n8n-nodes-base.stripe", models.NodeTypeApp},
		{"n8n-nodes-base.zendesk", models.NodeTypeApp},
		{"n8n-nodes-base.mailchimp", models.NodeTypeApp},
		{"n8n-nodes-base.azureStorage", models.NodeTypeApp},
		{"n8n-nodes-base.microsoftSharePoint", models.NodeTypeApp},
		{"n8n-nodes-base.microsoftGraphSecurity", models.NodeTypeApp},
		{"n8n-nodes-base.microsoftToDo", models.NodeTypeApp},
		{"n8n-nodes-base.microsoftEntra", models.NodeTypeApp},
		// New: File I/O nodes → tool
		{"n8n-nodes-base.extractFromFile", models.NodeTypeTool},
		{"n8n-nodes-base.spreadsheetFile", models.NodeTypeTool},
		{"n8n-nodes-base.ftp", models.NodeTypeTool},
		{"n8n-nodes-base.editImage", models.NodeTypeTool},
		// New: Utility → tool
		{"n8n-nodes-base.graphQl", models.NodeTypeTool},
		{"n8n-nodes-base.ssh", models.NodeTypeTool},
		{"n8n-nodes-base.dataTable", models.NodeTypeTool},
		// New: Workflow nodes
		{"n8n-nodes-base.stopAndError", models.NodeTypeWorkflow},
		{"n8n-nodes-base.executeWorkflowTrigger", models.NodeTypeWorkflow},
		// Trigger variants still map to workflow
		{"n8n-nodes-base.slackTrigger", models.NodeTypeWorkflow},
		{"n8n-nodes-base.kafkaTrigger", models.NodeTypeWorkflow},
		{"n8n-nodes-base.githubTrigger", models.NodeTypeWorkflow},
		{"n8n-nodes-base.telegramTrigger", models.NodeTypeWorkflow},
